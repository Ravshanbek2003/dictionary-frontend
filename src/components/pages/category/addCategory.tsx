...
import {useAddCategoryMutation, useGetCategoryByIdQuery, useUpdateCategoryMutation} from '@/app/api/category/category'
...
export const AddCategory = ({
  ...
  const {data} = useGetCategoryByIdQuery(dictionaryId as any, {
    skip: !dictionaryId,
  })
            ...
            <FormField
              ...
              render={({field}) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Misol: Kategoriya" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
